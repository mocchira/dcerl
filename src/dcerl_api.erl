...
-export([put/3, put_begin/2, put_chunk/3, put_end/3, remove/2, get/2, get_chunk/3, delete/1]). 
...
put(#dcerl_state{cache_entries     = CE, 
    ...
    DiffSize = erlang:size(Val) - filelib:file_size(DP),
